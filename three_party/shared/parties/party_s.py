...
class PartyS:
    ...
    def _setup_device(self) -> None:
        # S keeps V on GPU by default; CF_PARTY_DEVICE=cpu allows running S on
        # the CPU (useful for single-card three-process smoke tests).
        dev = os.environ.get("CF_PARTY_DEVICE", "cuda" if torch.cuda.is_available() else "cpu")
